...
4. :new: Закоммитьте и запушьте созданный проект на ГитХаб, [настройте GitHub Actions](https://github.com/netology-code/javaqa-homeworks-video/blob/javaqa-55/QA_CI.md), сделайте `git pull`.
...
1. :new: [Как настроить CI на основе Github Actions?](https://github.com/netology-code/javaqa-homeworks-video/blob/javaqa-55/QA_CI.md)
